...
public class LoginActivity extends AppCompatActivity {
    ...
    // --- Keep Executor, Handler, and URL from main ---
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Keep all initializations from main
        ...
        // Keep all click listeners from main
    ...
    // --- Keep Google Sign-In Flow methods from main ---
    ...
    // --- Keep Email/Password Sign-In Flow method from main ---
    // This version correctly uses Firebase Auth and calls the backend,
    // and removes the unnecessary role check and SharedPreferences logic from HEAD.
    ...
    /** Keep the backend call logic from main
    ...
    private void callBackendLogin(FirebaseUser user, @Nullable String role) {
        ...
        FirebaseMessaging.getInstance().getToken().addOnCompleteListener(tokenTask -> {
            ...
            executor.execute(() -> {
                ...
                // Updated default message slightly for clarity
                String responseMessage = "Login successful, connecting to server...";
                ...
                try {
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK || responseCode == HttpURLConnection.HTTP_CREATED) {
                        ...
                        // Log error and try to read error stream
                        Log.e(TAG, "Backend Error: " + responseCode);
                        responseMessage = "Login successful, but server sync failed."; // More specific default
                        try (BufferedReader br = new BufferedReader(new InputStreamReader(connection.getErrorStream(), StandardCharsets.UTF_8))) {
                            ...
                            try {
                                ...
                                if (jsonError.has("error")) {
                                    responseMessage = "Server sync error: " + jsonError.getString("error");
                                }
                            } catch (Exception jsonEx) { /* Ignore if not JSON */ }
                    ...
                    navigateToMain(); // Navigate regardless of sync success/failure after login
                }
            });
        });
    }

    // Keep helper methods from main
